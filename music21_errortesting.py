...
s = music21.converter.parse( r"D:\VScoding\MelodyDots\data\NostalgiasAmenor\score.xml" )
# s = music21.converter.parse( r"D:\python\Jana_Gana_Mana\Jana Gana Mana.musicxml" )
s.show( "braille.ascii", fp=r"D:\VScoding\MelodyDots\2braile\NostalgiasAmenor_2ndedit.brf" )
